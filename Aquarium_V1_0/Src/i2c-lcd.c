 ...
 * die wir sp�ter im main gebrauchen k�nnen.
 * Sie bestehen au:
 * 		-lcd_send_cmd
 * 		-lcd_send_data
 * 		-lcd_init
 ...
 * Befehle ans Display �bergeben werden. Die verschiedenen
 ...
 * gibt den Text auf dem Display aus, indem sie f�r jeden
 ...
 * angeben wo man hinspringen m�chte und sie versetzt den
 ...
 * nach links. Die Funktion wird bei l�schen gebraucht.
 * @param None
 * @retval None
 */
